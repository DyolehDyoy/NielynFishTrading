...
<!--     *************************     -->
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo format_currency_peso( $product['buy_price'], $CURRENCY_CODE); ?></td>
                <td class="text-center"> <?php echo format_currency_peso( $product['sale_price'], $CURRENCY_CODE); ?></td>

...
?>
  ...
  <?php  if ($session->isUserLoggedIn()): ?>
    <header id="header">
      <div class="logo pull-left"><img src="../SAD/uploads/logo/logo1.png" height="50" width="40">Nielyn Fish Trading
<!--
      <img src="../SAD/uploads/logo/logo1.png" height="60" width="140">
-->
